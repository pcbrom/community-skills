"""Smoke tests for the ggplot2 skill.

Skipped when Rscript is missing or the upstream `ggplot2` package is
...
pytestmark = pytest.mark.skipif(
    not _pkg_installed(),
    reason="R or upstream ggplot2 package not available",
)


def test_dispatcher_loads_and_rejects_unknown_fn():
    r = invoke("ggplot2", {"fn": "does_not_exist_certainly_xyz"})
